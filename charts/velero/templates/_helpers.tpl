...
{{ default .Values.provider .Values.backupStorageLocation.provider }}
{{- end -}}
...
{{- with .Values.volumeSnapshotLocation -}}
{{ default "default" .name }}
{{- end -}}
{{- end -}}
...
{{ default .Values.provider .Values.volumeSnapshotLocation.provider }}
{{- end -}}
